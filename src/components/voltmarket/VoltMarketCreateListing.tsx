  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const listingData = {
        ...
        // available_power_mw: formData.available_power_mw, // Column doesn't exist in table
        // square_footage: formData.square_footage, // Column may not exist in table
        // is_location_confidential: formData.is_location_confidential, // Column may not exist in table
        // The following columns don't exist in voltmarket_listings table yet:
