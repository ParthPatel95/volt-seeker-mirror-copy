-- Fix security warnings by adding SET search_path to database functions

-- Update function to update user progress with proper search_path
...
-- Update function to increment user points with proper search_path
...
-- Update generic increment function with proper search_path
